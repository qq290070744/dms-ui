...
本项目基于 <a href="https://github.com/sendya/ant-design-pro-vue.git" target="_blank">Ant-Design-Pro-Vue</a> ， 一个基于 <a href="https://vuecomponent.github.io/ant-design-vue/docs/vue/introduce-cn/" target="_blank">Ant Design of Vue</a> 的适用于企业应用程序的现成UI解决方案。

本项目在 [Ant-Design-Pro-Vue-**2.1.0**版本](https://github.com/sendya/ant-design-pro-vue/tree/dev/2.1.0) 的基础上修改或移除一些内容，如有需要请查询相关版本添加或修改回来。
